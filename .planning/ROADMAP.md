...
- [ ] **Phase 49: Loop Exit Edge Convention** — Derive loop exit button from the sole labeled outgoing edge; validator rejects zero or ≥2 labeled edges (1/5 plans: 49-01 shared node-label module ✅ 2026-04-19)
