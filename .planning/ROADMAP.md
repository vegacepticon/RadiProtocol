...
- [ ] **Phase 20: Housekeeping Removals** — Remove free-text-input type, retire awaiting-snippet-fill state, strip text-block snippet logic, polish Runner textarea
- [ ] **Phase 21: Color Infrastructure** — Canvas node color coding by type via CanvasLiveEditor, node-color-map constant, both PROTECTED_FIELDS copies updated
